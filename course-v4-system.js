window.COURSE_SYSTEM_V4 = {
  ...
  phases: [
    {
      ...
      outcome: "完成可取消、可测试、可诊断的个人 Go 练习仓库，并通过一次 Go 专项闭卷答辩。",
      bloom: "理解 → 应用 → 分析",
    ...
    },
    {
      ...
      outcome: "能为 6 类系统设计题写出可靠骨架，完整讲透其中一题，并在 15 分钟内用 metric/log/trace/profile 缩小故障范围。",
      bloom: "应用 → 分析 → 评价",
  ...
  serviceReplacement: [
    ...
    ["专项学习资料", "每周一份主资料；官方/一手资料仅在主资料缺口处核对"],
